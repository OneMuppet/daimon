...
META1 = "Version 2.3      ·      18 June 2026      ·      9 theorems machine-checked"
META2 = "45 ablation criteria   ·   86 tests   ·   deterministic   ·   pure-Rust   ·   A4"
DATEISO = "2026-06-18"
...
def draw_running(c, page, total):
    ...
    c.drawRightString(PW - RM, hy, "Technical Report  ·  v2.3")
    c.setStrokeColor(RULE)
    c.setLineWidth(0.6)
