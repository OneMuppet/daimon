...
META1 = "Version 1.0      ·      15 June 2026      ·      9 theorems machine-checked"
META2 = "39 ablation criteria   ·   66 tests   ·   deterministic   ·   pure-Rust   ·   no neural nets   ·   A4"
DATEISO = "2026-06-15"
...
def draw_running(c, page, total):
    ...
    c.drawRightString(PW - RM, hy, "Technical Report  ·  v1.0")
    c.setStrokeColor(RULE)
    c.setLineWidth(0.6)
