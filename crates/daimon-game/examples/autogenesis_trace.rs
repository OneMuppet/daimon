...
const GENE_NAMES: [&str; N_GENES] = [
    ...
    "metamotivation", "quantum", "foresight", "forage_drr", "social_forage", "cultural", "lp_curiosity", "stigmergy", "affect_mod", "can_fight", "can_build", "can_die", "can_grieve", "can_provision", "nn_enabled", "nn_learn_rate", "nn_modulation", "herd_evasion",
];
